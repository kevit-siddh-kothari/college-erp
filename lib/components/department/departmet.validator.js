...
const addDepartmentValidator = [
    (0, express_validator_1.body)('departmentname').notEmpty().isString().withMessage('Please enter a valid department name'),
];
...
const deleteDepartmentValidator = [(0, express_validator_1.param)('id').isMongoId().withMessage('Invalid department ID')];
