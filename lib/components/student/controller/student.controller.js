...
exports.getVacantSeats = exports.getAnalyticsData = exports.getAbsentStudents = exports.getAllStudent = exports.deleteAllStudents = exports.deleteStudentById = exports.updateStudentById = exports.addStudent = void 0;
...
const addStudent = async (req, res) => {
    try {
        ...
        const batchData = await batch_1.Batch.find({ year: batch }, { branches: 1, _id: 0 }).lean();
        ...
        await student.save();
        await batch_1.Batch.updateOne({ 'year': batch, 'branches.name': departmentname }, { $inc: { 'branches.$.availableSeats': -1, 'branches.$.occupiedSeats': 1 } });
...
const getAbsentStudents = async (req, res) => {
    try {
        ...
        const attendanceRecords = await attendance_1.Attendance.find({ createdAt: date }, { student: 1, _id: 0, present: 1, absent: 1 })
