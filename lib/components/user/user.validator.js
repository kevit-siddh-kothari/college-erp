...
const signUpValidator = [
    ...
    (0, express_validator_1.body)('role').isString().notEmpty().withMessage('Role is required').isIn(['admin', 'staffmember', 'student']).withMessage('Role must be either "admin" or "staffmember"'),
];
